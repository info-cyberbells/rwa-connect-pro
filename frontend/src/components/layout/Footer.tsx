        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground">
              <a href="mailto:contact@societysmarthub.com" className="flex items-center gap-2 hover:text-foreground transition-colors">
          ...
          <div>
            ...
            <div className="mt-6 space-y-3">
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 bg-muted rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors text-sm"
              >
