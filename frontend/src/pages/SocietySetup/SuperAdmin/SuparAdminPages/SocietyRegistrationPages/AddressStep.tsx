  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col ">
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-8 py-10 flex-1 flex flex-col items-center">
        ...
        <div className="w-full max-w-4xl bg-card rounded-[3.5rem] p-12 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] border border-slate-50 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-[700] text-foreground tracking-tighter mb-3 ">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  } rounded-[1.5rem] py-4 pl-14 pr-6 focus:bg-card focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition-all outline-none`}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full bg-muted/50 border border-border rounded-[1.5rem] py-4 pl-14 pr-6 focus:bg-card focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition-all outline-none"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="411045"
                  className={`w-full bg-muted/50 border ${
                    errors.pincode ? 'border-red-400' : 'border-border'
                  } rounded-[1.5rem] py-4 pl-14 pr-6 focus:bg-card focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition-all outline-none`}
                />
              </div>
            </div>
      ...
      <footer className="sticky bottom-0 bg-card/80 backdrop-blur-2xl border-t border-border px-16 py-8 flex justify-between items-center z-50">
        <button onClick={prevStep} className="text-muted-foreground font-black text-xs uppercase tracking-widest">
